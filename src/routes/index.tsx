...
import EcommerceProductDetails from '../pages/dashboard/UserNFTDetails';
  ...
  return useRoutes([
    ...
    // Dashboard Routes
    {
      ...
      children: [
        ...
        { path: 'aaa', element: <span>213123</span> },
        {
          path: 'user',
          children: [
            {
        ...
        {
          path: 'e-commerce/product/:name', element: <EcommerceProductDetails/>,
        },
      ],
    },
    {
      path: 'explore',
      element: <MainLayout />,
      children: [{ element: <Explore />, index: true }],
    },
    ...
    // Main Routes
    {
      ...
      children: [
        { path: 'kol', element: <ComingSoon /> },
        { path: 'explore', element: <ComingSoon /> },
        { path: 'plaza', element: <ComingSoon /> },
