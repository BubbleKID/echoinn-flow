...
import { kolAnswers, kolIntro, kolPrice } from './_kolIntro';
...
export const _carouselsMembers = [...Array(5)].map((_, index) => ({
  ...
  kolPrice: kolPrice[index],
  kolIntro: kolIntro[index],
  kolAnswers: kolAnswers[index],
}));
...
export const _contacts = [...Array(20)].map((_, index) => ({
  ...
  notification: randomNumberRange(0, 3),
}));
