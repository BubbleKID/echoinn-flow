...
export default function ProductDetailsSummary({
  ...
  const defaultValues = {
    id,
    TransactionHash: "0xff934b90cef5310d110e89fd2589c45b135e25add4b8d68b33d6169d21788b4b",
    name,
    cover,
    available,
    price,
  ...
  const mockPorduct = {
    ...
    Status: "Success",
    Block: "2322898",
    Timestamp: "12 hrs ago (Jun-17-2022 12:25:30 PM +UTC)",
    From: "0x40d55351adf4a1d5a4cfe48fe04b787b10d9b34f",
    InteractedWith: "Contract 0x86079a67dd8e1bbe4347dfcf9febf3b572e3b56f",
  }
  return (
    <RootStyle {...other}>
      <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
        ...
        <Typography variant="body2" sx={{ color: 'text.secondary' }}>
          {`Block: ${defaultValues.TransactionHash}`}
        </Typography>
        <Typography variant="body2" sx={{ color: 'text.secondary' }}>
          {`Timestamp: ${mockPorduct.Timestamp}`}
        </Typography>
        <Typography variant="body2" sx={{ color: 'text.secondary' }}>
          {`From: ${mockPorduct.From}`}
        </Typography>
        {/* </Stack> */}
